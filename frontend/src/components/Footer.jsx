...
function Footer() {
  return (
    <footer className="flex md:flex-row flex-col md:gap-12 gap-8 bg-transparent px-10 mt-12 py-6">
      <div className="flex items-center justify-center gap-1 pl-10 pr-20 md:pb-0 pb-8 md:border-r md:border-b-0 border-b border-[#9D9D9D]">
        <img src={bgRemovalLogo} className="h-7 w-7" alt="Bg-Removal Logo" />
      ...
      <div className="flex w-full flex-col items-center justify-center md:flex-row md:justify-between">
        ...
        >
          All Rights Reserved. &copy; Copyright @Bg.Removal.
        </Typography>
